...
import com.eyekey.conf.Configuration;
import com.eyekey.conf.MANIFESTConfig;
import com.eyekey.exception.EyeKeyException;
import com.eyekey.update.UpdateCheckThread;
...
public class EyeKeyHttp {
    ...
    // api.face-key.com
    private String webSite = "http://api.eyekey.com";

    /* 连接超时时间 */
    private int connTimeOut = 10 * 10000;
    ...
    private JSONObject httpGet(String url, Map<String, String> params) {
        ...
        try {
            ...
            conn.addRequestProperty("app_id", this.appId);
            conn.addRequestProperty("app_key", this.appKey);
    ...
    private String packageParams(Map<String, String> params) {
     ...
     * @Since 2015年1月6日
     */
    public JSONObject checkingImgB64(String img, String tip) {
        MultipartEntityBuilder builder = MultipartEntityBuilder.create();
        builder.addTextBody("app_id", appId);
        builder.addTextBody("app_key", appKey);
     ...
     * @return
     */
    public JSONObject iris_checkingImgB64(String img, String location, String tip) {
        MultipartEntityBuilder builder = MultipartEntityBuilder.create();
        builder.addTextBody("app_id", appId);
        builder.addTextBody("app_key", appKey);
        builder.addTextBody("img", img);
